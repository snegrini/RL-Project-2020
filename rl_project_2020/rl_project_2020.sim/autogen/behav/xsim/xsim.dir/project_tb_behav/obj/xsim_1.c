...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 1056416);
	iki_vhdl_file_variable_register(dp + 1056472);
	iki_vhdl_file_variable_register(dp + 1058896);
	iki_vhdl_file_variable_register(dp + 1583400);
	iki_vhdl_file_variable_register(dp + 1583488);
